# Control Server (Gateway API)

> The FastAPI backend providing REST endpoints, metric aggregation, and persistence.
...
```mermaid
graph TD;
    A[Client Request] -->|REST/Web| B(Control Server (Gateway API));
